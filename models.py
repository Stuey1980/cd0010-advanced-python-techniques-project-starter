...
class NearEarthObject:
    ...
    def fullname(self):
        ...
        # Use self.designation and self.name to build a fullname for
        # this object.
    ...
    def __str__(self):
        """Return `str(self)`."""
        # Use this object's attributes to return a human-readable
        # string representation.
        # The project instructions include one possibility. Peek at
        # the __repr__
        # method for examples of advanced string formatting.

        # Set text based on if hazardous or not
        if self.hazardous:
            haz = "is"
        else:
            haz = "is not"
        ...
        f"and {haz} potentially hazardous"
...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        # type and handle any edge cases.
        # The `cd_to_datetime` function will be useful.

        self.time = cd_to_datetime(info["cd"])  # Use cd_to_datetime
    ...
    @property
    def time_str(self):
        """Return formatted repr of CloseApproach approach time.
    ...
    def __str__(self):
        ...
        # formatting.
        return (f"At {self.time_str}, '{self.designation}' approaches Earth"
                f" at a distance of {self.distance:.2f} "
                f"au and a velocity of {self.velocity:.2f}km/s")

    def __repr__(self):
        """Return a computer-readable string repr of this object."""
